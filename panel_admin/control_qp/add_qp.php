...
<?php
    ...
    {
        $qp_dp = mysqli_escape_string($connection, $_FILES['image']['name']);
        ...
        $query = "INSERT INTO qp (qp_dp ,qp_data, qp_title, qp_sub, qp_sub_code, qp_branch, qp_sem, qp_year, qp_college, qp_info_1, qp_info_2, qp_contri_name, qp_contri_college)";

        $query .= "VALUES('{$qp_dp}', '{$qp_data}', '{$qp_title}', '{$qp_sub}', '{$qp_sub_code}', '{$qp_branch}', '{$qp_sem}', '{$qp_year}', '{$qp_college}', '{$qp_info_1}', '{$qp_info_2}', '{$qp_contri_name}', '{$qp_contri_college}')";
