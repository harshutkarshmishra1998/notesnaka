                                            ...
                                            <?php 
                                                ...
                                                while($row = mysqli_fetch_assoc($select_user))
                                                {
                                                    ...
                                                    while($row = mysqli_fetch_assoc($select_user_2))
                                                    {
                                                        ...
                                                        echo 
                                                            "<td>
                                                                <form method='post' action='show_user_data_history.php?user_code={$user_code}&file_data={$file_data}&data_id={$data_id}'>
                                                                    <div class='table-data-feature'>
                                                                        <button type='submit' class='item' data-toggle='tooltip' data-placement='top' title='View' name = 'view'>
                                                                            <i class='zmdi zmdi-eye'></i>
                                                                        </button>
                                                                        <button type='submit' class='item' data-toggle='tooltip' data-placement='top' title='Favourite' name = 'favourite'>
...
<?php
    ...
    if(isset($_POST['favourite']))
    {
        ...
        if($create_post_query)
        {
            header("Location: show_user_data_history.php?user_code={$user_code}");
        }
    }
