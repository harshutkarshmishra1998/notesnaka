...
<head>
    ...
    <title>Notes Naka | PDF Viewer</title>
    ...
    document.onkeydown = function(e) {
        if (e.which == 17) {
            isCtrl = true;
            alert("Control keys are disabled");
        }
...
<body tabindex="1" class="loadingInProgress">
    ...
    <div>
        <?php
            $file_data .= "../../../../../db_files/".$file_data
        ?>
        <input type="hidden" id="compressed" value="<?php echo $file_data ?>">
    </div>
